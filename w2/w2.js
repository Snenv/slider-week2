fetch('w2.json')
    ...
    .then(jsonData => {
        ...
        loadCarousel(jsonData.navItems, jsonData.socialIcons);
        initializeSplide(jsonData.navItems);
    })
...
function loadCarousel(navItems, socialIcons) {
    const carouselList = document.getElementById('carousel-list');
    navItems.forEach(block => {
...
function initializeSplide(navItems) {
